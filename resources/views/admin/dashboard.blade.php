<x-app-layout>
    <div class="flex w-full min-h-screen overflow-hidden">
        <x-sidebar />
        <div class="w-full p-5 dark:text-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 py-5">
                <div class="inline-flex flex border shadow-md rounded-lg w-auto px-4 py-5 items-center">
                    ...
                    <div class="justify-between w-full flex flex-wrap inline-flex">
                        <b class="mb-2">Welcome <br> <span class="text-sm text-gray-600 dark:text-gray-400">{{ Auth::user()->name }}</span></b>
                ...
                <div class="inline-flex flex border shadow-md rounded-lg w-auto p-5 items-center">
                    <span class="mr-3 rounded-full bg-gray-200 p-2 dark:bg-transparent dark:border dark:b-white">
                    ...
                    <b>Total Posts: {{ $postCount }}</b>
                </div>
                <div class="inline-flex flex border shadow-md rounded-lg w-auto p-5 items-center">
                    <span class="mr-3 rounded-full bg-gray-200 p-2 dark:bg-transparent dark:border dark:b-white">
                        <svg class="size-6" viewBox="0 0 22 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <b>Total Registered Users: {{ $userCount }}</b>
                </div>
                <div class="inline-flex flex border shadow-md rounded-lg w-auto p-5 items-center">
                    <span class="mr-3 rounded-full bg-gray-200 p-2 dark:bg-transparent dark:border dark:b-white">
                    ...
                    <b>Total Parameters: {{ $paramCount }}</b>
                </div>
            </div>
        </div>
    </div>
